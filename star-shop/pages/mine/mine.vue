<template>
	<view class="page" v-if="userinfo.username">
		<view class="header">
			...
			<image
				:src="src ? src : '../../static/image/default-headPic.png'"
				class="head-portrait"
				@click="changeHeadPic"
			>
			</image>
			<text class="nick-name">{{ userinfo.username }}</text>
		</view>
		...
		<view class="option" @click="toOrder">
			<image
				...
				class="option-img bigger"
			></image>
			<text class="desc">我的订单</text>
		</view>
		<view class="option" @click="gotoLogin">
